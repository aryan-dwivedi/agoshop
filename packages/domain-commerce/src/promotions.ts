...
export const personalizedOffers = async (a: {
    ...
    const surfaceFor = (liveSessionId: string | null): Surface =>
        liveSessionId ? 'live' : 'browse';
    ...
    return {
        applied: Object.values(appliedByCode),
        suppressed: Object.values(suppressedByCode),
    };
};
