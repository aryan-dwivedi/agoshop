...
import { liveSessionProducts, liveSessions, sellers } from '@shop/db/schema.js';
...
import { STATUS_RANK, UUID_PATTERN } from './types.js';
    ...
    const [row] = await db
        ...
        .where(
            and(
                ...
                eq(liveSessionProducts.isFeatured, true),
            ),
        )
