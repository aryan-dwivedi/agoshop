...
import { aiToolCallsTotal, toolLatencySeconds } from '@shop/platform/lib/metrics.js';
import { persistBodies } from '@shop/platform/lib/pii.js';
...
const executeOne = async (
    ...
    try {
        result = await runTool(conversation, invocation, surfaced);
