        ...
        >
            ...
            <dl className="mt-3 space-y-1.5">
                {SHORTCUTS.map((shortcut) => (
                    <div
                        key={shortcut.keys}
                        className="flex items-baseline gap-3 text-14"
                    >
                        <dt className="tnum w-24 shrink-0 font-semibold text-t1">
                            {shortcut.keys}
                        </dt>
            ...
            <p className="mt-3 text-13 text-t2">
                Every one of these is also a control you can click. Shortcuts pause while you are
                typing.
            </p>
        </div>
    </div>
