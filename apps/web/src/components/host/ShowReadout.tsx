import type { SessionAnalyticsDto, SessionProductDto } from '@shop/shared';
...
export const ShowReadout = ({
    ...
    const metrics = [
        {
            label: 'Orders',
            value: data === null ? '—' : data.orders.toLocaleString('en-IN'),
        },
        {
            label: 'Revenue',
            value: data === null ? '—' : formatInr(data.gmvMinorUnits),
        },
        {
            label: 'Conversion',
            value:
        ...
        {
            label: 'Add-to-carts',
            value: data === null ? '—' : data.addToCarts.toLocaleString('en-IN'),
        },
    ];
    return (
        <section
            className="border-t border-line p-3"
            aria-label="This show"
        >
                ...
                {products.map((product) => {
                    ...
                    return (
                        <li
                            ...
                            className="flex items-baseline gap-2 text-14"
                        >
