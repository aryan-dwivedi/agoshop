...
/**
 * The room's live-only markdown. Tier 3 is not a stored price — the server
 * re-evaluates it per request — so this panel moves the rule and then shows the
 * ladder viewers are already being served, rather than a number it worked out itself.
 */
