...
/**
 * The poll, opened from the deck rather than living in the room: a composer that is
 * on screen for the whole show is a composer taking space from the frame.
 */
export const PollPanel = ({
  ...
  const submit = useCallback(() => {
    ...
    setError(null);
    void api
      .post<{ poll: PollDto }>(`/api/sessions/${sessionId}/polls`, {
  ...
  return (
    <div
      role="dialog"
      aria-label="Poll"
      className="card animate-slide-up absolute bottom-full left-0 z-30 mb-2 w-[26rem] p-3 shadow-sheet"
    >
      ...
      {poll === null ? (
        <div className="mt-2 space-y-2">
          <input
            ...
            placeholder="Which shade should we restock first?"
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              className="btn-commit btn-sm ml-auto"
              disabled={busy}
              onClick={submit}
            >
