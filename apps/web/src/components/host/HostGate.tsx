...
export const HostLoading = (): JSX.Element => (<div data-surface="studio" data-room="broadcast" className="flex h-[100dvh] flex-col gap-2 bg-bg p-3">
    <div className="skeleton h-12 w-full"/>
    <div className="skeleton min-h-0 flex-1"/>
    <div className="skeleton h-16 w-full"/>
  </div>);
export const HostLoadError = ({ message }: {
    message?: string;
}): JSX.Element => (<div data-surface="studio" data-room="broadcast" className="flex h-[100dvh] items-center justify-center bg-bg p-6">
...
export const HostRoleGate = ({ slug }: {
    slug: string;
}): JSX.Element => (<div data-surface="studio" data-room="broadcast" className="flex h-[100dvh] items-center justify-center bg-bg p-6">
    <div className="card max-w-md p-6 text-center">
