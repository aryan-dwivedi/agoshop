...
export const Layout = ({ children }: { children: ReactNode }): JSX.Element => {
    ...
    return (
        ...
        >
            <div
                className={`flex min-h-screen flex-col ${immersiveLive ? 'h-dvh min-h-0 overflow-hidden' : ''}`}
            >
                <header className="sticky top-0 z-40 shrink-0 shadow-[0_2px_8px_rgb(0_30_96/0.14)]">
                    <div className="bg-[#0071dc]">
                        <div
                            className={`relative mx-auto flex h-[72px] items-center gap-2 px-3 md:gap-3 md:px-5 ${immersiveLive ? 'max-w-none' : 'max-w-page'}`}
                        >
                            <Wordmark />
                    ...
                    <div className="hidden border-b border-[#d5e5f5] bg-white sm:block">
                        <nav
                            ...
                            className={`relative mx-auto flex h-11 items-center gap-1 overflow-x-auto px-3 text-13 font-semibold text-[#001e60] scroll-none md:px-5 ${immersiveLive ? 'max-w-none' : 'max-w-page'}`}
                        >
                            <div className="relative shrink-0">
                                <button
                                    type="button"
                        ...
                        <div className="mx-auto grid max-w-page gap-6 px-5 py-8 sm:grid-cols-[1fr_auto] sm:items-center">
                            <div>
                                ...
                                <p className="mt-2 max-w-md text-13 text-white/70">
                                    Everyday value, live product help, and a cart that keeps the
                                    final price clear.
                                </p>
                            </div>
                            <nav
