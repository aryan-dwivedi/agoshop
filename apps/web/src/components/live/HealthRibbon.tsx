import type { StreamHealth, StreamHealthState } from '../../hooks/useStreamHealth';

import { HEALTH_STATE_BY_CODE } from '../../hooks/useStreamHealth';
            ...
            <div className="mt-1 flex items-baseline gap-2 text-14">
                ...
                {rate !== null && (
                    <span className="tnum text-t2">
                        ...
                        {health.lossPct !== null && health.lossPct > 0
                            ? ` · ${health.lossPct}% lost`
                            : ''}
                    </span>
                )}
