...
/**
 * The keyboard map. Every binding here is also a visible control, and everything
 * pauses while a text field has focus — a host typing a poll answer must not pin
 * product 3 with the "3" key.
 */
export const useHostKeyboard = ({
  ...
  useEffect(() => {
    ...
    const onKeyUp = (event: KeyboardEvent): void => {
      // Releasing either half of Shift+E is a release: the hold must not survive it.
