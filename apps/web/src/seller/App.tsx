...
const Loading = (): JSX.Element => (<div className="space-y-2 px-4 py-4" aria-busy="true" aria-label="Loading">
    <div className="skeleton h-6 w-56"/>
    <div className="skeleton h-4 w-80"/>
    <div className="skeleton h-40 w-full"/>
  </div>);
const NotFound = (): JSX.Element => (<div className="card animate-fade-in mx-auto mt-12 max-w-md p-5 text-center">
...
const Console = (): JSX.Element => (<SellerLayout>
    <Outlet />
  </SellerLayout>);
const StudioRealtime = ({ children }: {
    children: ReactNode;
}): JSX.Element => {
