...
/** The broadcast control room — orchestrates publish, monitor, deck, and sidebar. */
...
const Host = (): JSX.Element => {
  ...
  const onSessionUpdated = useCallback(
    (updated: LiveSessionDto) => {
      queryClient.setQueryData(['session', slug], (current: { session: LiveSessionDto } | undefined) =>
