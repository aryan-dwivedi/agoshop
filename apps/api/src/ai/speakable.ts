...
/** Prices are spoken, so every amount ships as a decimal string beside its paise. */
...
/** The `ai.tool_executed` payload the web client's cart toast renders directly. */
...
export const publishToolExecuted = (
  conversation: ConversationRecord,
  event: AiToolExecutedEvent,
): Promise<void> =>
  publishToUser(conversation.userId, EVENTS.aiToolExecuted, {
