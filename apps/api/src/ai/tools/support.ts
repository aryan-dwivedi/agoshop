...
type SupportToolInvocation = Extract<ToolInvocation, {
    name: 'escalate_to_human';
}>;
export const runSupportTool = async (conversation: ConversationRecord, call: SupportToolInvocation): Promise<Record<string, unknown>> => {
