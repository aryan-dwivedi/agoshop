...
const schema = z.object({
    ...
    CONVOAI_TURN_TIMEOUT_MS: int(12000),
    ...
    CONVOAI_SYSTEM_PROMPT: z
        .string()
        .default('You are the voice shopping assistant for an Indian live-commerce storefront. ' +
...
export const isRecordingViaAgora = env.RECORDING_PROVIDER === 'agora' ||
    (env.RECORDING_PROVIDER === 'auto' &&
        Boolean(env.RECORDING_STORAGE_VENDOR &&
