...
/**
 * One SSE connection per browser tab. `sessionId` is repeatable and declares which
 * session-scoped streams this connection wants; the process reference-counts the
 * matching Redis subscriptions and releases them on close.
 */
